defmodule CuriousMessengerWeb.Endpoint do
  ...
  socket "/live", Phoenix.LiveView.Socket # This was here before: , websocket: [connect_info: [session: @session_options]]
  ...
  plug Pow.Plug.Session, otp_app: :curious_messenger
