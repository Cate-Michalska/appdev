...
{:ok, %User{id: u1_id}} = Auth.create_user(%{nickname: "Cate"})
{:ok, %User{id: u2_id}} = Auth.create_user(%{nickname: "Kuba"})

{:ok, %Conversation{id: conv_id}} = Chat.create_conversation(%{title: "Same ol same ol"})
